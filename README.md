# Dr Kalpana Govindarasan

### Applied AI · Scientific software · Explainable decision support
...
- **Practical engineering:** Python applications with explicit validation, inspectable outputs and documented limitations.
- **Human oversight:** tools designed to support judgement, surface uncertainty and avoid presenting heuristic scores as facts.

## Current learning

I am studying the **Professional Certificate in Agentic AI from IITM Pravartak**, delivered with Emeritus.

My learning focus includes retrieval-augmented generation, embeddings, agent workflows, evaluation and deployment. The projects above distinguish what is implemented today from planned extensions.
...
**My approach:** start with a real problem, build a transparent baseline, test its behaviour and document what it cannot do.
